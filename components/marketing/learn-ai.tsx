      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          >
            ...
            {/* ── Gradient fade into dashboard mockup ── */}
            <div className="pointer-events-none relative mt-2 select-none bg-gradient-to-b from-[var(--card)] via-transparent to-transparent pt-8">
              <div className="px-4 pb-4 opacity-60">
                {/* Profile header */}
